...
echo "  ✓ All $TOTAL_STEPS plan steps"
echo "  ✓ Commits after each step"
echo "  ✓ Quality gates (from .dorian.json)"
echo "  ✓ PR creation"
echo "  ✓ Plan status update"
echo ""
...
log_success "✅ Execution agent completed successfully:"
echo ""
echo "   ✓ $TOTAL_STEPS plan steps executed"
echo "   ✓ All commits created"
echo "   ✓ Quality gates verified"
echo "   ✓ PR created and pushed"
echo "   ✓ Plan status updated to 'completed'"
echo ""
...
echo "   - Commit hashes"
echo ""
log_info "📦 After PR is merged, archive this plan:"
echo "   dorian archive $PLAN_FILE"
echo ""
